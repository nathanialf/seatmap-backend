...
public class FlightSearchHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        ...
        try {
            ...
            FlightSearchResponse response = searchFlightsWithSeatmapsFromAllSources(
                request.getOrigin(),
    ...
    private FlightSearchResponse searchFlightsWithSeatmapsFromAllSources(String origin, String destination, String departureDate, String travelClass, String flightNumber, Integer maxResults) throws SeatmapException {
